function ItemCard(item, params){
	...
	cardEl.innerHTML = '\
		...
		<br clear="all">' +
			...
			(item.atk ?       '<div class="atk f_l">'       + stat_namesDB.atk  + ': <b>' + item.atk       + '</b></div>' : '') +
			...
			(item.prc ?       '<div class="prc f_l">'       + stat_namesDB.prc   + ': <b>' + item.prc      + '</b></div>' : '') +
			(item.bl ?        '<div class="bl f_l">'        + stat_namesDB.bl    + ': <b>' + item.bl       + '</b></div>' : '') +
			(item.ev ?        '<div class="ev f_l">'        + stat_namesDB.ev    + ': <b>' + item.ev       + '</b></div>' : '') +
		'</div>\
		<br clear="all">\
	'
	return cardEl
