skills_data = {
	...
	"tree_12|92": {
		...
		"effects": {
			...
			"attribute_2": "Deals 24 ~ 28 damage starting from the second hit",
			"range": "1m",
			"radius": "5 м",
			"cast": "Instant",
			"cooldown": "45 sec"
	...
	"tree_23|163": {
		...
		"effects": {
			...
			"attribute_7": "Deals 12 ~ 14 damage on consecutive use up to 2 times",
			"attribute_8": "Не сбрасывает перезарядку приема",
			"range": "From User",
			"radius": "5 м",
			"cast": "Instant",
	...
	"tree_23|165": {
		...
		"effects": {
			...
			"attribute_5": "Сопротивление урону и негативным эффектам на 1 с.",
			"attribute_6": "Deals 12 ~ 14 damage on consecutive use up to 2 times",
